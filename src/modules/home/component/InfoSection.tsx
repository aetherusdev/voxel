...
function InfoSection() {
  ...
  const services = [
  {
    ...
    description: "Board-certified radiologists across key imaging specialties, ensuring accurate and clinically relevant interpretations.",
    icon: Stethoscope,
    iconBg: "bg-blue-50",
  ...
  },
  {
    ...
    description: "Round-the-clock reporting support with defined turnaround benchmarks for routine and emergency cases.",
    icon: Clock,
  ...
  },
  {
    ...
    description: "Encrypted data transmission, standardized protocols, and strict quality assurance processes.",
    icon: ShieldCheck,
    iconBg: "bg-indigo-50",
    ...
    variants: {
      ...
      show: { 
        scale: 1, 
        opacity: 1, 
        transition: { duration: 0.6, delay: 0.2, type: "spring" as const, stiffness: 100 } 
      },
    },
  },
  {
    title: "Structured Reporting Workflow",
    description: "Standardized reporting systems designed to integrate seamlessly with hospital and imaging center operations.",
    icon: Activity,
    iconBg: "bg-cyan-50",
  ...
  },
  {
    ...
    description: "Flexible reporting capacity to support growing institutions, multi-location networks, and high-volume workflows.",
    icon: Database,
    iconBg: "bg-slate-100",
    ...
    <section ref={ref} className="relative w-full overflow-hidden bg-white">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-0 py-20 flex flex-col gap-16 lg:gap-24 bordera-2 border-b-3 border-[#6666]">
        ...
        <div className="max-w-6xl">
          <h2 className="text-xl tracking-widest leading-7 font-normal font-playfair lg:leading-12 lg:text-4xl">
            Voxel Teleradiology is dedicated to providing high-quality
            diagnostic interpretations through a network of experienced
            radiologists and subspecialists. With standardized reporting
            systems, peer review mechanisms, and strict turnaround benchmarks,
            we ensure consistency and diagnostic reliability across modalities.
            We operate as an extension of your radiology department — delivering
            clarity when and where it is required.
          </h2>
        </div>
