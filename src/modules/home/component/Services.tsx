...
export const services = [
  ...
  {
    title: "STAT Reporting",
    description:
      "Priority reporting services with industry-leading turnaround for critical cases.",
  ...
  },
  {
    ...
    description:
      "Independent expert review of complex imaging to support confident clinical decisions.",
